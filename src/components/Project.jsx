...
export const Project = ({ image, alt, title }) => {
  return (
    <div className="relative max-h-[342px] max-w-[387px] h-full w-full rounded-[10px] overflow-hidden duration-300">
      ...
      <div className="absolute flex flex-col top-0 left-0 h-full w-full bg-opacity-0 group hover:bg-opacity-20 bg-white items-center justify-center duration-300 hover:backdrop-blur-[5px] ease-in-out space-y-4">
