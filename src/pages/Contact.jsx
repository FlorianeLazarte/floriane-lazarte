        ...
        <div className="flex gap-10 w-full">
          ...
          <form action="" className="w-full space-y-5 text-white max-w-[800px]">
            ...
            <textarea
              ...
              className="w-full rounded-[10px] bg-[#C6A4F0] bg-opacity-50"
            />
            <button
              type="submit"
              className="border bg-[#1E16A1] rounded-[8px] text-white text-[18px] px-[28px] py-[16px] mt-[30px] hover:bg-opacity-80"
            >
              Send message
            </button>
          </form>
